...
/**
 * The class <code>DCVMPerformance3brokers</code> implements the multi-JVM
 * assembly for our project, and as its name implies in this example we have three JVMs, each one of them will have 
 ...
 *
 */
public class DCVMPerformance3brokers extends AbstractDistributedCVM {
    ...
    protected static final int NB_BROKER                = 3;
    ...
    public DCVMPerformance3brokers(String[] args, int xLayout, int yLayout) throws Exception {
    ...
    public static void main(String[] args) {
        try {
            DCVMPerformance3brokers da = new DCVMPerformance3brokers(args, 2, 5);
