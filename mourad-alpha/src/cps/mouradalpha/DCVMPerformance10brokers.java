...
public class DCVMPerformance10brokers extends AbstractDistributedCVM {
    ...
    protected static final int NB_BROKER                = 10;
    protected static final int NB_PUBLISHER_PER_BROKER  = 20;
    protected static final int NB_SUBSCRIBER_PER_BROKER = 20; 

    protected static final long CYCLE_LIFE = 35000L;

    public DCVMPerformance10brokers(String[] args, int xLayout, int yLayout) throws Exception {
    ...
    public static void main(String[] args) {
        try {
            DCVMPerformance10brokers da = new DCVMPerformance10brokers(args, 2, 5);
