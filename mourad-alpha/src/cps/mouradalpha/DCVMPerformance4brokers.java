...
/**
 * The class <code>DCVMPerformance4brokers</code> implements the multi-JVM
 * assembly for our project, and as its name implies in this example we have four JVMs, each one of them will have 
 ...
 *
 */
public class DCVMPerformance4brokers extends AbstractDistributedCVM {
    ...
    protected static final int NB_BROKER                = 4;
    ...
    public DCVMPerformance4brokers(String[] args, int xLayout, int yLayout) throws Exception {
    ...
    public static void main(String[] args) {
        try {
            DCVMPerformance4brokers da = new DCVMPerformance4brokers(args, 2, 5);
